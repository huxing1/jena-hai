...
public class Hai2Owl {
    ...
    private static void resolveOwl() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, IOException {
                        ...
                        if (attorneysBean.getAttorney_type().getText().equals("律师")) {
                            ...
                            if (haiIndividual.isEmptyIndividual(lawyerKeyText, "律师姓名") != null) {
                               ...
                               //添加关系：被告人 --haslawyer->律师
                                if (defendantIndividual != null) defendantIndividual.addProperty(hasLawyerObjectProperty,lawyerIndividual);
                                //添加关系：辩护人--workOn->律师
                                if (defenderIndividual!=null) defenderIndividual.addProperty(workOnObjectProperty,lawyerIndividual);
                            }
                            //律所相关的实例
                            ...
                            if (haiIndividual.isEmptyIndividual(lawofficeKeyText, "律所名称") != null) {
                                ...
                                //添加关系：律师 --ttorney_name->律所
                                if (lawyerIndividual != null) lawyerIndividual.addProperty(isFromObjectProperty,lawofficeIndividual);
                            }
                        }
